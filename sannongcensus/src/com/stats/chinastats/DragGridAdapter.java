...
import com.stats.chinastats.util.ImgAsync_List;
...
public class DragGridAdapter extends BaseAdapter {
	...
	public DragGridAdapter(Context mContext,GridView listview, ArrayList<ContentItem> list) {
		...
		listview.setSelector(R.drawable.selector_null_to_red);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	if(map!=null &&map.getText().equals("none")){
			txt.setText("");
			img.setImageBitmap(null);
		...
		/*	Drawable cachedImage = asyncImageLoader_Weibo.loadDrawable(context,
			...
			relate.setBackgroundResource(Data.gridbackground[position]);
		}
