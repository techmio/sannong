package com.stats.chinastats.myview;
...
public class MyPullToRefreshListView extends LinearLayout{
	...
	private int TOP_LAYOUTHEIGHT = 50;
	...
	public void setRefreshViewHeight(int height) {
		...
		if (height == 1) {
			mRefreshView.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,(int) (mContext.getResources().getDisplayMetrics().density*TOP_LAYOUTHEIGHT+1)));
		} else {
